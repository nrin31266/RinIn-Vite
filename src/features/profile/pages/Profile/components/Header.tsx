...
const Header = ({user}: Props) => {
  ...
  return (
    <div className='w-full bg-white shadow rounded-[8px]'>
        <img src="/test2.jpg" className='w-full  h-[11rem] sm:h-[13rem] md:h-[15rem] xl:h-[19rem] object-cover object-center rounded-[8px_8px_0_0]'  alt="" />
        <div className='flex justify-start px-2 items-center -mt-12'>
            <div className='grid grid-cols-[auto_1fr]'>
                <img src={"/avatar.jpg"} alt="" className='border-6 scale-z-50 border-white size-30 rounded-full'/>
