...
const ConversationHeader = () => {
  ...
  return (
    <div className='grid grid-cols-[auto_1fr_auto] gap-4 items-center px-4 border-gray-200 h-full'>
        <img src={recipient?.profilePicture || "/avatar.jpg"} alt="" className='h-12 w-12 object-cover rounded-full' />
       <h2 className='text-lg font-semibold'>{recipient?.firstName + " " + recipient?.lastName}</h2>
